 ...
 * @typedef {LineStringProperties}
 * @extends {ICoordinateContainer<Position[], Point[], SerialLineString>}
 */
 ...
 * @date 2/11/2024 - 6:35:28 PM
 *
 * @param {LineStringProperties} item
 * @returns {boolean}
 */
 ...
 */
  ...
  /**
 * Creates an instance of LineString.
 * @date 2/11/2024 - 6:35:28 PM
 *
 * @constructor
 * @protected
 ...
 * @returns {LineString}
 */
  static fromPoints(points: Point[], bbox?: BoundingBox | null): LineString {
    const lineString = new LineString();
