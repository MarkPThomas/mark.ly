 ...
 * @typedef {PolygonProperties}
 * @extends {ICoordinateContainer<Position[][], Point[][], SerialPolygon>}
 */
 ...
 */
   ...
   * @memberof Polygon
   */
  static fromPoints(points: Point[][], bbox?: BoundingBox | null): Polygon {
    const polygon = new Polygon();
