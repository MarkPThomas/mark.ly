 ...
 * @template {Node<V>} N
 * @template V
 * @implements {ILinkedList<N, V>}
 * @implements {IEquatable<ILinkedList<N, V>>}
 */
 ...
 *
 * @protected
 * @type {(EqualityCallback<V> | undefined)}
 */
 ...
 * @date 2/11/2024 - 6:33:22 PM
 *
 * @param {LinkedList<N, V>} linkedList
 * @returns {boolean}
 */
 ...
 * @returns {({ node: N, index: number } | null)\}
 */
  find(
    valueOrNode: V | N,
 ...
 * @date 2/11/2024 - 6:33:22 PM
 *
 * @param {(V | N)} refValueOrNode
 * @param {(V | N)} insertValueOrNode
 * @param {EqualityCallbackOptions<V>} [cb=undefined]
 * @returns {boolean}
 */
  insertBefore(
 ...
 *
 * @protected
 * @param {ILinkedList<N, V>} leftList
 * @param {ILinkedList<N, V>} rightList
 * @param {(V | N)} valueOrNode
 * @param {EqualityCallbackOptions<V>} [cb=undefined]
 * @returns {[
 ...
 * @date 2/11/2024 - 6:33:22 PM
 *
 * @param {(V[] | N[] | ILinkedList<N, V>)} items
 ...
 * @param {V} endValue
 * @param {EqualityCallbackOptions<V>} [cb=undefined]
 * @returns {{ startNode: N; startNodeCount: number; endNode: N; endNodeCount: number; endNodePrev: any; }\}
 */
 ...
 * @date 2/11/2024 - 6:33:22 PM
 *
 * @param {(V | N)} startValueOrNode
 * @param {(V | N)} endValueOrNode
 * @param {boolean} [returnListCount=false]
 * @param {EqualityCallbackOptions<V>} [cb=undefined]
 * @returns {{
 *     count: number,
 ...
 * @date 2/11/2024 - 6:33:22 PM
 *
 * @param {EqualityCallback<V>} callBack
 */
