  ...
  describe('Common Interfaces', () => {
    ...
    describe('#equals', () => {
      it('should return False for linked lists with differing node values', () => {
        ...
        const linkedList1 = new LinkedListDouble<number>(values1);

        const values2 = [6, 7, 8, 9, 10];
        const linkedList2 = new LinkedListDouble<number>(values2);
      ...
      it('should return True for linked lists with identical node values', () => {
        const values = [1, 2, 3, 4, 5];
        const linkedList1 = new LinkedListDouble<number>(values);
        const linkedList2 = new LinkedListDouble<number>(values);
