  ...
  describe('Single Item Operations', () => {
    ...
    describe('#remove', () => {
      ...
      it('should remove the node from a list where the node is found & return the removed node', () => {
        const values = [1, 2, 3, 4, 5];
        const linkedList = new LinkedListSingle<number>(values);
        const targetNode = new NodeSingle<number>(3);
      ...
      it('should remove the last remaining node in a list that matches the specified node', () => {
        ...
        linkedList.remove(new NodeSingle<number>(3));
        expect(linkedList.size()).toEqual(4);
        linkedList.remove(new NodeSingle<number>(2));
        expect(linkedList.size()).toEqual(3);
        linkedList.remove(new NodeSingle<number>(4));
        expect(linkedList.size()).toEqual(2);
        linkedList.remove(new NodeSingle<number>(5));
        expect(linkedList.size()).toEqual(1);
        linkedList.remove(new NodeSingle<number>(1));
        expect(linkedList.size()).toEqual(0);
        expect(linkedList.head).toBeNull();
        expect(linkedList.tail).toBeNull();
    ...
    describe('#trim', () => {
      ...
      it('should return null & do nothing on an empty list with a provided node', () => {
        ...
        const trimmedHead = linkedList.trim(new NodeSingle(2), new NodeSingle(4));
  ...
  describe('Head Operations', () => {
    ...
    describe('#trimHead', () => {
      ...
      it('should return null & do nothing on an empty list with a provided node', () => {
        ...
        const trimmedHead = linkedList.trimHead(new NodeSingle(2));
  ...
  describe('Tail Operations', () => {
    ...
    describe('#trimTail', () => {
      ...
      it('should return null & do nothing on an empty list with a provided node', () => {
        ...
        const trimmedHead = linkedList.trimTail(new NodeSingle(2));
  ...
  describe('"Many" Operations', () => {
    ...
    describe('#insertManyBefore', () => {
      ...
      it('should insert the provided array node items before the reference and return the number of items inserted into the array', () => {
        ...
        const addedNodes: NodeSingle<number>[] = [
          new NodeSingle(10),
          new NodeSingle(9),
          new NodeSingle(8)];
        const returnListCount = true;
  ...
  describe('Misc Operations', () => {
    ...
    describe('#toLinkedListDouble', () => {
      it('should convert the linked list to a doubly linked list', () => {
        ...
        expect(result.head).toHaveProperty('prev');
...
describe('##LinkedList', () => {
  it('should create a singly linked list of a derived node', () => {
    const linkedList = new LinkedList<NodeKeyVal<number, string>, string>();
    linkedList.append(new NodeKeyVal(0, 'A'));
    linkedList.append(new NodeKeyVal(1, 'B'));
    linkedList.append(new NodeKeyVal(2, 'C'));
