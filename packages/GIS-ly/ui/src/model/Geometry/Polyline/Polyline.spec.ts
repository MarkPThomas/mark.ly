...
describe('##Polyline', () => {
  ...
  describe('Updating Stats After Modification', () => {
    ...
    it('should get stats froma custom range', () => {
      const startVertex = polyline.firstVertex.next as VertexNode<TestVertex, Segment>;
      const endVertex = polyline.lastVertex.prev as VertexNode<TestVertex, Segment>;
      const result = polyline.statsFromTo(startVertex, endVertex);
    ...
    it('should skip nodes not meeting callback criteria provided', () => {
      const startVertex = polyline.firstVertex as VertexNode<TestVertex, Segment>;
      const endVertex = polyline.lastVertex.prev as VertexNode<TestVertex, Segment>;
      const isLengthConsidered = (length: number) => length > 1;

      const result = polyline.statsFromTo(startVertex, endVertex, { isLengthConsidered });
    ...
    it('should return updated stats when polyline start vertex is changed', () => {
      const result = polyline.stats;
      ...
      const resultModifed = polyline.stats;
    ...
    it('should return updated stats when polyline end vertex is changed', () => {
      const result = polyline.stats;
    ...
    it('should return updated stats when polyline middle vertex is removed', () => {
      const result = polyline.stats;
    ...
    it('should return updated stats when polyline middle vertex is inserted', () => {
      const result = polyline.stats;
