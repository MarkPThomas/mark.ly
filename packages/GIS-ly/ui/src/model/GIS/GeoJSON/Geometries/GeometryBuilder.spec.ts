...
describe('##GeometryBuilder', () => {
  ...
  describe('#getCoordinates', () => {
    ...
    it('should get coordinates for a MultiPoint geometry', () => {
      ...
      const expectedPoints = multiPointJson.coordinates.map((coordinate: Position) => Point.fromPosition(coordinate));
    ...
    it('should get coordinates for a LineString geometry', () => {
      ...
      const expectedPoints = lineStringJson.coordinates.map((coordinate: Position) => Point.fromPosition(coordinate));
    ...
    it('should get coordinates for a MultiLineString geometry', () => {
      ...
      const expectedPoints = multiLineStringJson.coordinates.flat(1).map(
    ...
    it('should get coordinates for a Polygon geometry', () => {
      ...
      const expectedPoints = polygonJson.coordinates.flat(1).map(
        (coordinate: Position) => Point.fromPosition(coordinate)
      );
    ...
    it('should get coordinates for a MultiPolygon geometry', () => {
      ...
      const expectedPoints = multiPolygonJson.coordinates.flat(2).map(
        (coordinate: Position) => Point.fromPosition(coordinate)
      );
    ...
    it('should get coordinates for a GeometryCollection geometry', () => {
      ...
      const expectedPoints = [[-1, -2], [1, 2], [3, 4]].map(
        (coordinate: Position) => Point.fromPosition(coordinate)
      );
    ...
    it('should get coordinates for a Feature containing a MultiPoint geometry', () => {
      ...
      const expectedPoints = (featureJson.geometry as SerialMultiPoint).coordinates.map(
        (coordinate: Position) => Point.fromPosition(coordinate)
      );
